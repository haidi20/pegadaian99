            ...
            <div class="modal-body">
                ...
                <div class="tab-content modal-body">
                    <div class="tab-pane active" id="tab-home" role="tabpanel">
                        ...
                        @include('akad.modal.index.detail-action.detail-nasabah')
                    </div>
                    <div class="tab-pane" id="tab-profile" role="tabpanel">
                        {{-- <h6>Data Akad</h6> --}}
                        @include('akad.modal.index.detail-action.data-akad')
                    </div>
                    <div class="tab-pane" id="tab-messages" role="tabpanel">
                        {{-- <h6>Bea Titip</h6> --}}
                        @include('akad.modal.index.detail-action.biaya-titip')
                    </div>
                    <div class="tab-pane" id="tab-settings" role="tabpanel">
                        {{-- <h6>Rincian Akad</h6> --}}
                        @include('akad.modal.index.detail-action.rincian-akad')
                    </div>
                </div>
            </div>
        </div>
