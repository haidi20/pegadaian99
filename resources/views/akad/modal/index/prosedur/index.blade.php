...
<div class="modal fade" id="modal-akad-ulan"  tabindex="-1" aria-hidden="true" style='z-index:10000;' role="dialog">
...
<!-- The Modal -->
<div class="modal fade" id="modal-akad-ulang">
                                ...
                                <div class="general-info">
                                    <div class="row" id="data-detail">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="table-responsive">
                                                <table class="table m-0">
                                                    <tbody id="table-detail-one" class="data-nasabah">
                                                        <tr>
                                                            <td>Nama Lengkap</td>
                                                            <td class="data-nama_lengkap"></td>
                                                        </tr>
