        ...
        <div class="row">
            <div class="col-sm-4 col-md-4">
                <div class="form-group">
                    ...
                    <select name="by" id="by" class="form-control">
                        @foreach($columnPelunasanLelang['list_nasabah_lelang'] as $index => $item)
                            <option value="{{$index}}" {{selected($index, 'by', 'request')}}>{{$item}}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="row">
            <div class="col-sm-4 col-md-4">
                <div class="form-group">
                    ...
                    <select name="by" id="by" class="form-control">
                        @foreach($columnPelunasanLelang['list_nasabah_refund'] as $index => $item)
                            <option value="{{$index}}" {{selected($index, 'by', 'request')}}>{{$item}}</option>
                        @endforeach
                    </select>
                </div>
