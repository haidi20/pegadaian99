                ...
                <div class="card-block">
                    ...
                    <form action="{{route('cabang.store')}}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="investor" id="investor">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="modal_awal">Modal Awal</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="modal_awal" id="modal_awal">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="no_cabang">No. Cabang</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="no_cabang" id="no_cabang">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="telp_cabang" id="telp_cabang">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="alamat_cabang">Alamat Cabang</label>
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" class="form-control" id="alamat_cabang" name="alamat_cabang" ></textarea>
                            </div>
                        </div>
